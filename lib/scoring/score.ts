 ...
 * otherwise returns 0 and the caller drops the momentum weight via
 * composite(subs, { skipMomentum: true }), rebalancing the other four
 * signals (no IG observed should neither inflate nor penalize a score).
 *
