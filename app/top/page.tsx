...
export const metadata = {
  title: "Talk of the Town, Signal Pittsburgh",
  description:
        ...
        <article className="mx-auto max-w-7xl px-6 pt-10 pb-14 md:pt-16 md:pb-20">
          <Reveal as="header">
            ...
            >
              ...
              <span className="text-brand-black">Talk of the Town</span>
            </nav>
            ...
            <h1 className="mt-8 font-display font-black uppercase tracking-[-0.02em] text-brand-black [text-wrap:balance] text-[clamp(2.25rem,7.5vw,6rem)] leading-[0.92]">
              Pittsburgh&apos;s <span className="bg-brand-lime px-2 box-decoration-clone">Talk of the Town</span>
            </h1>

            <p className="mt-6 max-w-2xl font-body text-base md:text-lg text-brand-black/75 leading-relaxed">
              Talk of the Town is the top of the index per category. Both
              sides of the conversation move at once: the business posts,
              and the city posts back. Pick a category to read the list.
            </p>
          </Reveal>
