...
export function GetFeaturedCTA({
  ...
  return (
    <Reveal as="section" className="block">
      <div className="border-2 border-brand-purple bg-brand-purple/5 px-6 py-7 md:px-9 md:py-9">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-5 md:gap-8 items-center">
          <div>
            ...
            <h3 className="font-display font-black uppercase tracking-[-0.01em] text-brand-black text-xl md:text-2xl leading-[1.1] [text-wrap:balance]">
              Get {businessName} featured by a Pittsburgh creator.{" "}
              <span className="bg-brand-lime px-1.5 box-decoration-clone">
                Free.
              </span>
            </h3>
            <p className="mt-3 font-body text-sm md:text-base text-brand-black/70 max-w-2xl leading-relaxed">
              Pittsburgh creators register on Relay specifically to feature
              local small businesses. There&apos;s no fee for verified
              owners. Apply once and Relay handles the introductions.
            </p>
          </div>
          <a
            href={href}
