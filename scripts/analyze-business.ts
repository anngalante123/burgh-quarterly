...
Never use the word "median" anywhere. It reads as jargon and creates "median of what?" ambiguity for non-stats readers. If you'd reach for "median," reach for one of these instead: "the industry typical," "the industry average," "what this industry usually has," concrete rank-of-N like "5th of 6 in the industry," or just "the industry" / "peers" / "most other Cafes." Do not use the word "family" in user-facing copy; the cohorts are business-type industries (Sweets, Cafes, Bars, Restaurants), so say "industry."
